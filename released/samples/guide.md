...
![图片指定为线条网格背景](pic/vlook-mark-light.svg?darksrc=vlook-mark-dark.svg#padding#line "指定在 Dark Mode 时替换为指定图片")
...
>
> [<kbd>主按钮 ![](pic/icon-more.svg?fill=text)</kbd>](guide2.md#按钮链接) *[<kbd>次按钮 ![](pic/icon-more.svg?fill=text)</kbd>](guide2.md#按钮链接)*
>
> > ###### 更多信息
> >
> > - [x] 这是一个任务清单项
