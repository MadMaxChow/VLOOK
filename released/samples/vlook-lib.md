...
> **° 章节标题自动编号**
>
> 对文档内的章节标题进行**自动分级编号** [❯❯](guide3.md#章节自动编号)
>
> _~Bu~_
...
> **° 导航中心**
>
> 适用于按目录、分类内容索引（目录/插图/表格/多媒体/代码块）进行**全文档**跨章节的快速定位 [❯❯](guide3.md#导航中心)
>
> _~Bu~_
...
> **° 文库导航**
>
> 适用于将相关话题、内容的文档简介、链接，通过一个独立页面进行快速浏览和跳转 [❯❯](guide3.md#文库导航)
>
> _~Bu~_
