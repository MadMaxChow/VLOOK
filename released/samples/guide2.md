---
title: 快速参考手册 (Part.II) - VLOOK™ - 优雅好用的 Typora 主题与增强插件 VLOOK™
author: MAX°孟兆
...
针对不同形式的内容，提供自适应的快捷辅助功能。目前支持的内容形式包括：[表格](guide.md#°表格)、[插图](guide.md#°图片)、[标签](#标签)、[徽章](#徽章)、[刮刮卡](#刮刮卡)、[代码与代码块](guide.md#°代码与代码块)、[公式](#更实用美观的公式)、[面包屑](#面包屑)。
