...
- Тематический пакет и расширённый плагин, признанные и поддерживаемые Typora, для подробностей: [Typora Support - Export](https://support.typora.io/Export/#example-export-using-vlook)
