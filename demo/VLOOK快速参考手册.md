...
`最新版本丨V9 beta`    `+ 官网丨https://github.com/madmaxchow/VLOOK +`    `* 适用平台丨Typora for Win & macOS *`    `- 开源协议丨MIT -`   `! 开发语言丨JavaScript, CSS !`
...
![VLOOK内置的视觉样式主题](https://ws3.sinaimg.cn/large/006tNbRwgy1fyhutcwmw6j33ji0u01h9.jpg)
...
- 在进行文档评审时，可以通过激活聚光灯来让观众聚焦于文档的特定区域和内容；
